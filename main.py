...
if __name__ == "__main__":
    ...
    for replicate in range(1, reps + 1):
       ...
       #Wipe the OLED screen
        ...
        buzz_file = os.path.join(day_folder, day + '_' + str(replicate) + '_' + Name + '_buzz.json')
        DHT_file = os.path.join(day_folder, day + '_' + str(replicate) + '_' + Name + '_DHT.json')
        audio_file = os.path.join(day_folder, day + '_' + str(replicate) + '_' + Name + '_audio.wav')
        video_file = os.path.join(day_folder, day + '_' + str(replicate) + '_' + Name + '_video.h264')
